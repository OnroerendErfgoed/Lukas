 ...
 * @license   http://opensource.org/licenses/mit-license.php The MIT License
 */
class ConjunctiveExpressionList extends ExpressionList
{
    ...
    {
        return array("Operator"=>"OR", "Expressions"=>$this->expressions);
    }
    ...
    {
        $visitor->visitConjunctiveExpressionList($this);
    }
}
